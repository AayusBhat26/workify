...
export const AddUserImage = ({ profileImage, className, fullname }: Props) => {
        ...
        <div className="w-full flex flex-col justify-center items-center gap-2 mt-4">
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                    <Button
                        className={cn(
                            // Increased button size: from w-16 h-16 md:w-20 md:h-20 to w-20 h-20 md:w-24 md:h-24
                            "group relative bg-muted w-52 h-52 md:w-32 md:h-32 rounded-full flex justify-center items-center text-muted-foreground overflow-hidden",
                            className
                        )}
                    >
                        {profileImage ? (
                ...
                <DialogContent className="flex flex-col items-center justify-center sm:max-w-[28rem] p-0">
                    ...
                    {imagePreview ? (
                        <div className="rounded-full w-64 h-64 sm:w-64 sm:h-64 relative overflow-hidden my-5">
                            <Image
                                src={imagePreview}
                                alt=""
                                fill
                        ...
                        <UserAvatar
                            className="w-64 h-64 sm:w-64 sm:h-64 my-5"
                            size={64}
