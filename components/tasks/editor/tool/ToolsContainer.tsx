...
export const ToolsContainer = ({ editor }: Props) => {
  ...
  return (
    <div className="flex items-center border rounded-md shadow-sm bg-popover p-1 text-popover-foreground gap-1 max-w-[13rem] flex-wrap sm:max-w-lg">
      ...
      <OptionBtn
        onClick={() => editor.chain().focus().setMark("textStyle", { color: "#8b5cf6" }).run()}
        className={
      ...
      <OptionBtn
        onClick={() => editor.chain().focus().setMark("textStyle", { color: "#f59e0b" }).run()}
        className={
      ...
      <OptionBtn
        onClick={() => editor.chain().focus().setMark("textStyle", { color: "#10b981" }).run()}
        className={
      ...
      <OptionBtn
        onClick={() => editor.chain().focus().setMark("textStyle", { color: "#38bdf8" }).run()}
        className={
